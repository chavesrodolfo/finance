    ...
    <Card className="bg-card/50 backdrop-blur-sm border-border/20">
      <div className="p-4 md:p-6">
        <div className="flex justify-between items-center mb-3 md:mb-4">
          ...
          <Skeleton className="h-8 w-8 md:h-9 md:w-9 rounded-full bg-muted/30" />
        </div>
        <Skeleton className="h-7 w-24 md:h-9 md:w-32 mb-1 md:mb-2" />
...
export function TransactionListSkeleton() {
  return (
    <Card className="bg-card/50 backdrop-blur-sm border-border/20 h-[400px] md:h-[450px]">
      <div className="p-4 md:p-6 flex flex-col h-full">
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <Skeleton className="h-4 w-28 md:h-5 md:w-36" />
          <Skeleton className="h-7 w-20 md:h-8 md:w-24 rounded-md bg-muted/30" />
        </div>
            ...
            <div key={index} className="flex justify-between items-center">
              <div className="flex items-center gap-2 md:gap-3 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  <Skeleton className="h-3 w-20 md:h-4 md:w-32 mb-1" />
                  <Skeleton className="h-2 w-16 md:h-3 md:w-24" />
                </div>
              </div>
              <div className="text-right ml-2">
                <Skeleton className="h-3 w-12 md:h-4 md:w-16 mb-1" />
                <Skeleton className="h-2 w-8 md:h-3 md:w-12" />
              </div>
            </div>
          ))}
        </div>
...
export function BudgetCardSkeleton() {
  return (
    <Card className="bg-card/50 backdrop-blur-sm border-border/20 h-[400px] md:h-[450px]">
      <div className="p-4 md:p-6 flex flex-col h-full">
        <div className="flex items-center justify-between mb-4 md:mb-6">
          <Skeleton className="h-4 w-20 md:h-5 md:w-28" />
          <Skeleton className="h-7 w-20 md:h-8 md:w-24 rounded-md bg-muted/30" />
        </div>
        
        {/* Total Budget */}
        <div className="p-3 md:p-4 bg-muted/20 rounded-lg mb-4 md:mb-6">
          <Skeleton className="h-2 w-16 md:h-3 md:w-20 mb-1 md:mb-2" />
          ...
          {[80, 65, 45, 30].map((width, index) => (
            <div key={index} className="group">
              ...
              <div className="flex items-center">
                <div className="w-full h-3 md:h-4 bg-muted/30 rounded-md overflow-hidden">
                  <Skeleton 
      ...
      <div className="p-4 md:p-6 flex flex-col h-full">
        ...
        <div className="p-3 md:p-4 bg-muted/20 rounded-lg mb-4 md:mb-6">
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            <div>
              <Skeleton className="h-2 w-12 md:h-3 md:w-16 mb-1 md:mb-2" />
              <Skeleton className="h-5 w-20 md:h-6 md:w-24" />
            </div>
            <div>
              <Skeleton className="h-2 w-16 md:h-3 md:w-20 mb-1 md:mb-2" />
          ...
          {Array.from({ length: 3 }).map((_, index) => (
            <div key={index} className="flex justify-between items-center">
              <div className="flex-1 min-w-0 mr-2">
                <Skeleton className="h-3 w-20 md:h-4 md:w-28 mb-1" />
                <Skeleton className="h-2 w-12 md:h-3 md:w-16" />
              </div>
              <div className="text-right">
                <Skeleton className="h-3 w-16 md:h-4 md:w-20 mb-1" />
                <Skeleton className="h-2 w-8 md:h-3 md:w-12" />
              </div>
            </div>
          ))}
